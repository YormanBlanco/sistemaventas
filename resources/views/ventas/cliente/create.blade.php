...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <form action="{{url('ventas/cliente')}}" method="POST">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                    <div class="form-group">
                        ...
                        <input type="text" name="num_documento" placeholder="Ejemplo: V-XXXXXXXX o E-XXXXXXXXXX" required value="{{old('num_documento')}}" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="form-group">
                    ...
                    <a href="{{url('ventas/cliente')}}" class="btn btn-danger">Cancelar</a>  
                </div>   
            </div>      
