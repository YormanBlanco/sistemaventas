...
<div class="row">
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <h3> Lstado de clientes <a href="{{url('ventas/cliente/create')}}" class="btn btn-primary">Nuevo</a> </h3>
                ...
                <tbody>
                    @foreach($personas as $per)
                        <tr>                           
                            ...
                            <td>
                                <a href="{{url ('/ventas/cliente/'.$per->id.'/edit')}}" class="btn btn-info">Editar</a>
